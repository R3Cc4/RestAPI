...
import org.vamsi.restapi.messenger.resources.beans.MessageFilterBean;
import org.vamsi.restapi.messenger.services.MessageService;
...
public class MessageResource {
	...
	public List<Message> getMessages(@BeanParam MessageFilterBean filterBean) {
		if(filterBean.getYear()>0) return messageService.getAllMessagesYear(filterBean.getYear());
